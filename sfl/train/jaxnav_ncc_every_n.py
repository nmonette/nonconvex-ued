...
def main(config):
    ...
    def train_and_eval_step(runner_state, t):
        ...
        rng, train_state, xhat, prev_grad, y_opt_state = runner_state
        ...
        # TRAIN
        runner_state = (rng, train_state, xhat, prev_grad, y_opt_state)
        ...
        test_metrics["meta_entropy"] =  -jnp.dot(sampler["scores"], jnp.log(sampler["scores"] + 1e-6))
        test_metrics["meta_loss"] =  new_sampler["scores"].T @ new_score
